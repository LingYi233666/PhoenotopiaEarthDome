...
STRINGS.NAMES.ATHETOS_MEDKIT_BIG_PLAN1 = STRINGS.NAMES.ATHETOS_MEDKIT_BIG
STRINGS.NAMES.ATHETOS_MEDKIT_BIG_PLAN2 = STRINGS.NAMES.ATHETOS_MEDKIT_BIG
...
STRINGS.NAMES.ATHETOS_GRENADE_ELEC_PLAN1 = STRINGS.NAMES.ATHETOS_GRENADE_ELEC
STRINGS.NAMES.ATHETOS_GRENADE_ELEC_PLAN2 = STRINGS.NAMES.ATHETOS_GRENADE_ELEC
...
STRINGS.GALE_UI.SKILL_NODES = {
	...
	MULTITHRUST = {
		NAME = "多重突刺",
		DESC = "进行多重突刺，造成多段伤害。能在装备撬棍、矛类武器时使用。",
	},
