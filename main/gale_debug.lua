...
GALE_LOREM_IPSUM_CHS_NO_UPDATE =
...
-- HyperBurn(ThePlayer:GetPosition() + Vector3(0,0.5,0),TheInput:GetWorldPosition())
function HyperBurn(start_pos, end_pos)
    ...
    for i = 0, towards_len, step do
        ...
        segment.vfx:DoEmit(towards_norm * 0.5)
