...
local function defaultfn()
    ...
    -- inst:SetPrefabNameOverride("punchingbag")

    -- inst.AnimState:OverrideSymbol("hair", "gale_punchingbag", "hair")
    inst.AnimState:OverrideSymbol("headbase", "gale_punchingbag", "headbase")
    inst.AnimState:OverrideSymbol("leg", "gale_punchingbag", "leg")
    inst.AnimState:OverrideSymbol("torso_comp", "gale_punchingbag", "torso_comp")
...
return Prefab("gale_punchingbag", defaultfn, assets)
