...
local COLOUR_ENVELOPE_NAME_SMOKE = "gale_fire_explode_vfx_colourenvelope_smoke"
local SCALE_ENVELOPE_NAME_SMOKE = "gale_fire_explode_vfx_scaleenvelope_smoke"
local COLOUR_ENVELOPE_NAME_EMBER = "gale_fire_explode_vfx_colourenvelope_ember"
local SCALE_ENVELOPE_NAME_EMBER = "gale_fire_explode_vfx_scaleenvelope_ember"
local COLOUR_ENVELOPE_NAME_CIRCLE = "gale_fire_explode_vfx_colourenvelope_circle"
local SCALE_ENVELOPE_NAME_CIRCLE = "gale_fire_explode_vfx_scaleenvelope_circle"
local COLOUR_ENVELOPE_NAME_SMOKE2 = "gale_fire_explode_vfx_colourenvelope_smoke2"
local SCALE_ENVELOPE_NAME_SMOKE2 = "gale_fire_explode_vfx_scaleenvelope_smoke2"
local COLOUR_ENVELOPE_NAME_ARROW = "gale_fire_explode_vfx_colourenvelope_arrow"
local SCALE_ENVELOPE_NAME_ARROW = "gale_fire_explode_vfx_scaleenvelope_arrow"
...
local function InitEnvelope()
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 138, 0, 0) },
            { 0.02,    IntColour(255, 138, 0, 90) },
    ...
    EnvelopeManager:AddColourEnvelope(
        COLOUR_ENVELOPE_NAME_EMBER,
        {
            ...
            { 0,    IntColour(255, 84, 2, 25) },
            { .075,   IntColour(255, 84, 5, 200) },
            { .3,   IntColour(255, 54, 5, 255) },
            { .6,   IntColour(255, 54, 5, 255) },
            { .9,   IntColour(255, 50, 0, 230) },
            { 1,    IntColour(255, 50, 0, 0) },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 138, 0, 0)},
            { .075,   IntColour(255, 140, 0, 255)},
            { .3,   IntColour(255, 138, 5, 60) },
            { .6,   IntColour(255, 138, 5, 50) },
            { .9,   IntColour(255, 138, 0, 25) },
            { 1,    IntColour(255, 138, 0, 0) },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 50, 54, 0)},
            { .2,   IntColour(255, 50, 54, 240)},
            { .3,   IntColour(200, 48, 60, 60) },
            { .6,   IntColour(230, 48, 90, 50) },
            { .9,   IntColour(255, 50, 70, 25) },
            { 1,    IntColour(255, 50, 70, 0) },
        }
    )
...
local function emit_smoke_fn(effect, sphere_emitter, adjust_vec)
    local vx, vy, vz = .25 * UnitRand(), .1 + .15 * UnitRand(), .25 * UnitRand()
...
return Prefab("gale_fire_explode_vfx", fn, assets)
