local assets =
{
    ...
    Asset("ANIM", "anim/galeboss_katash_firepit.zip"),
}
...
local function updatefuelrate(inst)
    inst.components.fueled.rate = TheWorld.state.israining and inst.components.rainimmunity == nil and
...
local function fn()
    ...
    inst.AnimState:AddOverrideBuild("galeboss_katash_firepit")
...
return Prefab("galeboss_katash_firepit", fn, assets)
