...
local COLOUR_ENVELOPE_NAME_SMOKE = "gale_normal_explode_vfx_colourenvelope_smoke"
local SCALE_ENVELOPE_NAME_SMOKE = "gale_normal_explode_vfx_scaleenvelope_smoke"
local COLOUR_ENVELOPE_NAME_EMBER = "gale_normal_explode_vfx_colourenvelope_ember"
local SCALE_ENVELOPE_NAME_EMBER = "gale_normal_explode_vfx_scaleenvelope_ember"
local COLOUR_ENVELOPE_NAME_CIRCLE = "gale_normal_explode_vfx_colourenvelope_circle"
local SCALE_ENVELOPE_NAME_CIRCLE = "gale_normal_explode_vfx_scaleenvelope_circle"
local COLOUR_ENVELOPE_NAME_SMOKE2 = "gale_normal_explode_vfx_colourenvelope_smoke2"
local SCALE_ENVELOPE_NAME_SMOKE2 = "gale_normal_explode_vfx_scaleenvelope_smoke2"
local COLOUR_ENVELOPE_NAME_ARROW = "gale_normal_explode_vfx_colourenvelope_arrow"
local SCALE_ENVELOPE_NAME_ARROW = "gale_normal_explode_vfx_scaleenvelope_arrow"
...
return Prefab("gale_normal_explode_vfx", fn, assets)
