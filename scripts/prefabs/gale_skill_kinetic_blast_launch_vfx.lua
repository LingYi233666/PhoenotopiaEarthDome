...
local COLOUR_ENVELOPE_NAME_SMOKE = "gale_skill_kinetic_blast_launch_vfx_colourenvelope_smoke"
local SCALE_ENVELOPE_NAME_SMOKE = "gale_skill_kinetic_blast_launch_vfx_scaleenvelope_smoke"
local COLOUR_ENVELOPE_NAME_EMBER = "gale_skill_kinetic_blast_launch_vfx_colourenvelope_ember"
local SCALE_ENVELOPE_NAME_EMBER = "gale_skill_kinetic_blast_launch_vfx_scaleenvelope_ember"
local COLOUR_ENVELOPE_NAME_CIRCLE = "gale_skill_kinetic_blast_launch_vfx_colourenvelope_circle"
local SCALE_ENVELOPE_NAME_CIRCLE = "gale_skill_kinetic_blast_launch_vfx_scaleenvelope_circle"
local COLOUR_ENVELOPE_NAME_SMOKE2 = "gale_skill_kinetic_blast_launch_vfx_colourenvelope_smoke2"
local SCALE_ENVELOPE_NAME_SMOKE2 = "gale_skill_kinetic_blast_launch_vfx_scaleenvelope_smoke2"
local COLOUR_ENVELOPE_NAME_ARROW = "gale_skill_kinetic_blast_launch_vfx_colourenvelope_arrow"
local SCALE_ENVELOPE_NAME_ARROW = "gale_skill_kinetic_blast_launch_vfx_scaleenvelope_arrow"
...
local function InitEnvelope()
    ...
    EnvelopeManager:AddColourEnvelope(
        COLOUR_ENVELOPE_NAME_EMBER,
        {
            ...
            { 0,    IntColour(200, 200, 0, 25) },
            { .075,   IntColour(230, 220, 0, 200) },
            { .3,   IntColour(255, 200, 0, 255) },
            { .6,   IntColour(255, 200, 0, 255) },
            { .9,   IntColour(255, 200, 0, 230) },
            { 1,    IntColour(255, 180, 0, 0) },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        COLOUR_ENVELOPE_NAME_CIRCLE,
        {
            ...
            { .3,   IntColour(200, 220, 0, 60) },
            { .6,   IntColour(230, 220, 0, 50) },
            { .9,   IntColour(255, 200, 0, 25) },
            { 1,    IntColour(255, 200, 0, 0) },
        }
    )

    local circle_max_scale = 10
    EnvelopeManager:AddVector2Envelope(
    ...
    local circle_max_scale = 1
    EnvelopeManager:AddVector2Envelope(
        SCALE_ENVELOPE_NAME_SMOKE2,
        {
            { 0,    { circle_max_scale * 0.33, circle_max_scale * 0.33 } },
            { 0.15,    { circle_max_scale * 1, circle_max_scale * 1 } },
            { 1,    { circle_max_scale * 1, circle_max_scale * 1 } },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 200, 0, 180) },
            { .2,   IntColour(255, 210, 0, 255) },
            { .6,   IntColour(255, 200, 0, 175) },
            { 1,    IntColour(0, 0, 0, 0) },
        }
    )
...
local SMOKE2_MAX_LIFETIME = 0.55
...
local function emit_ember_fn(effect, sphere_emitter, adjust_vec)            
    ...
    local vec = Vector3(px, py, pz):GetNormalized() * GetRandomMinMax(0.6,0.8)
...
local function emit_arrow_fn(effect, sphere_emitter, adjust_vec)            
    ...
    local vec = Vector3(px, py, pz):GetNormalized() * GetRandomMinMax(0.4,0.5)
    -- local vx, vy, vz = .17 * UnitRand(), .17 * math.random(), .17 * UnitRand()
...
return Prefab("gale_skill_kinetic_blast_launch_vfx", fn, assets)
