...
local COLOUR_ENVELOPE_NAME = "gale_portal_teleport_vfx_colourenvelope"
local SCALE_ENVELOPE_NAME = "gale_portal_teleport_vfx_scaleenvelope"
...
local function emit_sparkle_fn(effect, sphere_emitter)
    local vx, vy, vz = .04 * UnitRand(), .05 * UnitRand(), .04 * UnitRand()
...
local function fn()
    ...
    effect:SetDragCoefficient(0,0.05,0)
...
return Prefab("gale_portal_teleport_vfx", fn, assets)
