...
local COLOUR_ENVELOPE_NAME_FLAME_WHITE = "gale_flame_vfx_white_colourenvelope"
...
local colour_index = {
    ...
    COLOUR_ENVELOPE_NAME_FLAME_WHITE,
}
...
local scale_index = {
    ...
    SCALE_ENVELOPE_NAME_FLAME_TINY,
}
...
local function InitEnvelope()
    ...
    EnvelopeManager:AddColourEnvelope(COLOUR_ENVELOPE_NAME_FLAME_WHITE, {
