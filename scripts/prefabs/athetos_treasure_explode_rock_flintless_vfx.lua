local GLITCH_TEXTURE = resolvefilepath("fx/athetos_treasure_rock_flintless.tex")

local ADD_SHADER = "shaders/vfx_particle_add.ksh"

local COLOUR_ENVELOPE_NAME = "athetos_treasure_explode_rock_flintless_vfx_colourenvelope"
local SCALE_ENVELOPE_NAME = "athetos_treasure_explode_rock_flintless_vfx_scaleenvelope"
...
return Prefab("athetos_treasure_explode_rock_flintless_vfx", fn, assets)
