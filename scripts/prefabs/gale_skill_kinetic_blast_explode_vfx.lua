...
local ANIM_SMOKE2_TEXTURE = "fx/animsmoke2.tex"
...
local COLOUR_ENVELOPE_NAME_SMOKE = "gale_skill_kinetic_blast_explode_vfx_colourenvelope_smoke"
local SCALE_ENVELOPE_NAME_SMOKE = "gale_skill_kinetic_blast_explode_vfx_scaleenvelope_smoke"
local COLOUR_ENVELOPE_NAME_EMBER = "gale_skill_kinetic_blast_explode_vfx_colourenvelope_ember"
local SCALE_ENVELOPE_NAME_EMBER = "gale_skill_kinetic_blast_explode_vfx_scaleenvelope_ember"
local COLOUR_ENVELOPE_NAME_CIRCLE = "gale_skill_kinetic_blast_explode_vfx_colourenvelope_circle"
local SCALE_ENVELOPE_NAME_CIRCLE = "gale_skill_kinetic_blast_explode_vfx_scaleenvelope_circle"
local COLOUR_ENVELOPE_NAME_SMOKE2 = "gale_skill_kinetic_blast_explode_vfx_colourenvelope_smoke2"
local SCALE_ENVELOPE_NAME_SMOKE2 = "gale_skill_kinetic_blast_explode_vfx_scaleenvelope_smoke2"
local COLOUR_ENVELOPE_NAME_ARROW = "gale_skill_kinetic_blast_explode_vfx_colourenvelope_arrow"
local SCALE_ENVELOPE_NAME_ARROW = "gale_skill_kinetic_blast_explode_vfx_scaleenvelope_arrow"
...
local function InitEnvelope()
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 200, 0, 0) },
            { 0.02,    IntColour(255, 200, 0, 90) },
            { .05,   IntColour(10, 10, 10, 180) },
    ...
    EnvelopeManager:AddColourEnvelope(
        COLOUR_ENVELOPE_NAME_EMBER,
        {
            ...
            { 0,    IntColour(255, 200, 2, 25) },
            { .075,   IntColour(255, 200, 5, 200) },
            { .3,   IntColour(255, 180, 5, 255) },
            { .6,   IntColour(255, 180, 5, 255) },
            { .9,   IntColour(255, 170, 0, 230) },
            { 1,    IntColour(255, 170, 0, 0) },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 200, 0, 0)},
            { .075,   IntColour(255, 210, 0, 255)},
            { .3,   IntColour(255, 200, 5, 60) },
            { .6,   IntColour(255, 200, 5, 50) },
            { .9,   IntColour(255, 200, 0, 25) },
            { 1,    IntColour(255, 200, 0, 0) },
        }
    )

    local circle_max_scale = 20
    EnvelopeManager:AddVector2Envelope(
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 200, 0, 0)},
            { .2,   IntColour(255, 200, 0, 240)},
            { .3,   IntColour(200, 190, 0, 60) },
            { .6,   IntColour(230, 190, 0, 50) },
            { .9,   IntColour(255, 200, 0, 25) },
            { 1,    IntColour(255, 200, 0, 0) },
        }
    )

    local circle_max_scale = 1.75
    EnvelopeManager:AddVector2Envelope(
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(255, 180, 70, 180) },
            { .2,   IntColour(255, 210, 90, 255) },
            { .6,   IntColour(255, 200, 70, 175) },
            { 1,    IntColour(0, 0, 0, 0) },
        }
    )
...
local function emit_ember_fn(effect, sphere_emitter, adjust_vec)            
    ...
    local vec = Vector3(px, py, pz):GetNormalized() * GetRandomMinMax(0.8,1.2)
    -- local vx, vy, vz = .17 * UnitRand(), .17 * math.random(), .17 * UnitRand()
    local vx,vy,vz = (vec + Vector3(0,GetRandomMinMax(0.06,0.25),0)):Get()
...
local function emit_smoke_fn(effect, sphere_emitter, adjust_vec)
    local vx, vy, vz = .3 * UnitRand(), .1 + .2 * UnitRand(), .3 * UnitRand()
...
local function emit_arrow_fn(effect, sphere_emitter, adjust_vec)            
    ...
    local vec = Vector3(px, py, pz):GetNormalized() * GetRandomMinMax(0.7,0.8)
    -- local vx, vy, vz = .17 * UnitRand(), .17 * math.random(), .17 * UnitRand()
...
local function common_fn()
    ...
    --SMOKE
    effect:SetRenderResources(1, ANIM_SMOKE2_TEXTURE, REVEAL_SHADER)
...
return Prefab("gale_skill_kinetic_blast_explode_vfx", fn, assets)