...
local COLOUR_ENVELOPE_NAME_SMOKE = "gale_dark_explode_vfx_colourenvelope_smoke"
local SCALE_ENVELOPE_NAME_SMOKE = "gale_dark_explode_vfx_scaleenvelope_smoke"
local COLOUR_ENVELOPE_NAME_EMBER = "gale_dark_explode_vfx_colourenvelope_ember"
local SCALE_ENVELOPE_NAME_EMBER = "gale_dark_explode_vfx_scaleenvelope_ember"
local COLOUR_ENVELOPE_NAME_CIRCLE = "gale_dark_explode_vfx_colourenvelope_circle"
local SCALE_ENVELOPE_NAME_CIRCLE = "gale_dark_explode_vfx_scaleenvelope_circle"
local COLOUR_ENVELOPE_NAME_SMOKE2 = "gale_dark_explode_vfx_colourenvelope_smoke2"
local SCALE_ENVELOPE_NAME_SMOKE2 = "gale_dark_explode_vfx_scaleenvelope_smoke2"
local COLOUR_ENVELOPE_NAME_ARROW = "gale_dark_explode_vfx_colourenvelope_arrow"
local SCALE_ENVELOPE_NAME_ARROW = "gale_dark_explode_vfx_scaleenvelope_arrow"
...
local function InitEnvelope()
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(5, 5, 5, 0) },
            { 0.02,    IntColour(7, 7, 7, 90) },
            { .05,   IntColour(10, 10, 10, 255) },
            { .3,   IntColour(10, 10, 10, 250) },
            { .7,  IntColour(0, 0, 0, 250) },
            { 1,    IntColour(0, 0, 0, 0) },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(2, 2, 2, 25) },
            { .075,   IntColour(5, 5, 5, 200) },
            { .3,   IntColour(5, 5, 5, 255) },
            { .6,   IntColour(5, 5, 5, 255) },
            { .9,   IntColour(0, 0, 0, 230) },
            { 1,    IntColour(0, 0, 0, 0) },
        }
    )

    local ember_max_scale = 1.5
    EnvelopeManager:AddVector2Envelope(
        SCALE_ENVELOPE_NAME_EMBER,
        {
            { 0,    { ember_max_scale, ember_max_scale } },
            { 1,    { ember_max_scale * 0.7, ember_max_scale * 0.7 } },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(0, 0, 0, 0)},
            { .075,   IntColour(5, 5, 5, 255)},
            { .3,   IntColour(0, 0, 0, 60) },
            { .6,   IntColour(0, 0, 0, 50) },
            { .9,   IntColour(0, 0, 0, 25) },
            { 1,    IntColour(0, 0, 0, 0) },
        }
    )

    local circle_max_scale = 17
    EnvelopeManager:AddVector2Envelope(
        SCALE_ENVELOPE_NAME_CIRCLE,
        {
            { 0,    { circle_max_scale, circle_max_scale } },
            { 1,    { circle_max_scale * 1.5, circle_max_scale * 1.5 } },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            -- { 0,    IntColour(255, 250, 254, 0)},
            -- { .2,   IntColour(255, 250, 254, 240)},
            -- { .3,   IntColour(200, 248, 255, 60) },
            -- { .6,   IntColour(230, 248, 255, 50) },
            -- { .9,   IntColour(255, 250, 255, 25) },
            -- { 1,    IntColour(255, 250, 255, 0) },
...
local function emit_smoke_fn(effect, sphere_emitter, adjust_vec)
    local vx, vy, vz = .4 * UnitRand(), .1 + .3 * UnitRand(), .4 * UnitRand()
...
return Prefab("gale_dark_explode_vfx", fn, assets)
